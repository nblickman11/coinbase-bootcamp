...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.9/contracts/token/ERC721/IERC721Receiver.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.9/contracts/token/ERC721/ERC721.sol
...
contract HaikuNFT is ERC721 {
    ...
    mapping(string => bool) public lineExists;
    ...
    function mintHaiku(string memory line1, string memory line2, string memory line3) external {
        ...
        // Check if haiku line already exists.
        if (lineExists[line1] == true || lineExists[line2] == true || lineExists[line3] == true) {
            revert HaikuNotUnique();
        }
        lineExists[line1] = true;
        lineExists[line2] = true;
        lineExists[line3] = true;

        // Initialize and save haiku.
        Haiku memory haiku = Haiku(msg.sender,line1,line2,line3);
        haikus.push(haiku);
    ...
    function shareHaiku(address _to, uint tokenId) public {
        sharedHaikus[_to].push(tokenId);
    }
